...
public class CuentasPorCobrar extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        razSocial = jTable1.getValueAt(tabla, 1).toString();
        txtRazSocialReport.setText(razSocial);
        listaVentasCobrarReporteTotal("c.razonSocial", razSocial);
        habilitarBuscar();
...
//--------------------------------------- Tabla 1 -----------------------------------------
    void listaVentasCobrar(String nombreFiltro, String valorFiltro) {
        ...
        try {
            lista = registroventacontroler.RegistroVentaCuentasCobrarClientes(nombreFiltro, valorFiltro);
            verVentas(lista);
...
//--------------------------------------- Tabla 2 -----------------------------------------
    void listaVentasCobrarReporteVencidos(String nombreFiltro, String valorFiltro) {
        List<RegistroVenta> lista;
        try {
            lista = registroventacontroler.RegistroVentaCuentasCobrarVencidos(nombreFiltro, valorFiltro);
...
//            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    void listaVentasCobrarReporteTotal(String nombreFiltro, String valorFiltro) {
        List<RegistroVenta> lista;
        try {
