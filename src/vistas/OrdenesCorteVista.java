...
//            jTable1.setForeground(Color.black);
    ...
    private void buttonVerOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVerOrdenActionPerformed
        ...
        try {
            consultarOrdenCorteInfo(numOrden,anio);
        } catch (Exception ex) {
            Logger.getLogger(OrdenesCorteVista.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void consultarClienteInfo(int idc) throws Exception {
        pro2 = obj2.ClienteBuscar1(idc);
        if (pro2 != null) {
            codigoCliente=pro2.getCodigoCliente();
    ...
    private void consultarOrdenCorteInfo(String nO, int aio) throws Exception {
        pro = obj.OrdenCorteBuscarInfo(nO,aio);
        if (pro != null) {
