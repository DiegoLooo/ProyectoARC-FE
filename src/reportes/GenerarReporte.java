...
//            JasperPrint mostrarReporte = JasperFillManager.fillReport(reporteJasper, parametro, conexion);
            ...
            urlPdf = "\\\\ARCRODINPC-02\\Archivos Arcrodin\\AREA VENTAS\\COTIZACIONES\\COTIZACION " + codigo + "-" + fecha + "-" + tipo + "-" + cliente + ".pdf";
...
//            jv.setVisible(true);
     ...
     public void ReporteGuiaGuardar(int idGuia, String serie, String numero) throws SQLException, ClassNotFoundException, IOException {
        try {
            String urlPdf;
...
//            JasperPrint mostrarReporte = JasperFillManager.fillReport(reporteJasper, parametro, conexion);
            ...
            JasperReport jr = JasperCompileManager.compileReport(dise);
            JasperPrint mostrarReporte = JasperFillManager.fillReport(jr, parametro, conexion);
            urlPdf = "\\\\ARCRODINPC-02\\Archivos Arcrodin\\AREA LOGISTICA Y ALMACEN\\GUIAS REMISION REMITENTE\\GUIA REMISION - FORMATO IMPRESORA MATRICIAL\\GUIA REMISION " + serie + "-" + numero +".rtf";
            JRRtfExporter exporter = new JRRtfExporter ();
            exporter.setParameter (JRExporterParameter.JASPER_PRINT, mostrarReporte); 
            exporter.setParameter (JRExporterParameter.OUTPUT_FILE, new File(urlPdf));
...
//            JasperReport reporte= (JasperReport) JRLoader.loadObject("report3.jasper");
            ...
            urlPdf = "\\\\ARCRODINPC-02\\Archivos Arcrodin\\AREA CONTABILIDAD Y TESORERIA\\CAJA\\CAJA CHICA "+anio+" "+ dia1 + "." + mes1 + " - " + dia2 + "." + mes2 + ".pdf";
            JasperExportManager.exportReportToPdfFile(mostrarReporte, urlPdf);
            JasperViewer.viewReport(mostrarReporte, false);
...
//            JasperReport reporte= (JasperReport) JRLoader.loadObject("report3.jasper");
    ...
    public void ReporteOrdenTrabajoGuardar(int idOrdenTrabajo,String  nOt, String fechaAnio, String nCot, String cliente ) throws SQLException, ClassNotFoundException {
        try {
            ...
            JasperReport jr = JasperCompileManager.compileReport(dise);
            JasperPrint mostrarReporte = JasperFillManager.fillReport(jr, parametros, conexion);
            urlPdf = "\\\\ARCRODINPC-02\\Archivos Arcrodin\\AREA PRODUCCION\\ORDENES DE TRABAJO\\ORDEN DE TRABAJO " + nOt + "-" + fechaAnio + " SEGUN COT " + nCot + "- " + cliente + ".pdf";
            JasperExportManager.exportReportToPdfFile(mostrarReporte, urlPdf);
            JasperViewer.viewReport(mostrarReporte, false);
    ...
    public void ReporteOrdenCompraGuardar(int idOrdenCompra, String  nOC, String fechaEmision, String proveedor, String docExt ) throws SQLException, ClassNotFoundException {
        try {
            ...
            JasperReport jr = JasperCompileManager.compileReport(dise);
            JasperPrint mostrarReporte = JasperFillManager.fillReport(jr, parametros, conexion);
            urlPdf = "\\\\ARCRODINPC-02\\Archivos Arcrodin\\AREA COMPRAS\\ORDENES DE COMPRA\\ORDEN DE COMPRA " + nOC + "- " + fechaEmision+ "- " + proveedor + "- " + docExt + ".pdf";
            JasperExportManager.exportReportToPdfFile(mostrarReporte, urlPdf);
            JasperViewer.viewReport(mostrarReporte, false);
...
//            JasperReport reporte= (JasperReport) JRLoader.loadObject("report3.jasper");
    ...
    public void ImprimirCuentasCobrar(String razSocial, String estado) throws SQLException, ClassNotFoundException {
     ...
     public void ReporteCuentasCobrarTodo(String razSocial, String estado) throws SQLException, ClassNotFoundException {
        try {
            String urlPdf;
...
//            JasperReport reporte= (JasperReport) JRLoader.loadObject("report3.jasper");
            ...
            InputStream reporte = getClass().getResourceAsStream("/reportes/reportDeudaPrueba_1.jrxml");
            JasperDesign dise = JRXmlLoader.load(reporte);
            JasperReport jr = JasperCompileManager.compileReport(dise);
            JasperPrint mostrarReporte = JasperFillManager.fillReport(jr, parametros, conexion);
    ...
    public void ImprimirCuentasCobrarTodo(String razSocial, String estado) throws SQLException, ClassNotFoundException {
     ...
     public void ReportePedido(int idPedido) throws SQLException, ClassNotFoundException, IOException {
        try {
//            String urlPdf;
...
//            JasperReport reporte= (JasperReport) JRLoader.loadObject("report3.jasper");
            ...
            parametro.put("idPedidoVar", idPedido);

//            String dir= System.getProperty("user.dir")+"\\src\\reportes\\reportProforma_1.jrxml";
//            JasperReport reporteJasper = JasperCompileManager.compileReport(dir);
//            JasperPrint mostrarReporte = JasperFillManager.fillReport(reporteJasper, parametro, conexion);
            InputStream reporte = getClass().getResourceAsStream("/reportes/reportPedido.jrxml");
            JasperDesign dise = JRXmlLoader.load(reporte);
            JasperReport jr = JasperCompileManager.compileReport(dise);
            JasperPrint mostrarReporte = JasperFillManager.fillReport(jr, parametro, conexion);
//            urlPdf="\\\\ARCRODINPC-01\\Archivos Arcrodin 2017\\COTIZACIONES\\COTIZACIONES SISTEMA\\COTIZACION "+codigo+"-"+fecha+"-"+tipo+"-"+cliente+".pdf";
//            JasperExportManager.exportReportToPdfFile(mostrarReporte, urlPdf);
    ...
    public void ImprimirPedido(int idPedido) throws SQLException, ClassNotFoundException {
