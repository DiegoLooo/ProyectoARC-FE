...
public class DetalleOrdenCompra {
    ...
    public DetalleOrdenCompra(int doc_id, String doc_item, String doc_cantidad, String doc_desc, String doc_precioUnit, String doc_total) {
     ...
     public DetalleOrdenCompra(int doc_id, String doc_item, String doc_cantidad, String doc_desc,String doc_valorUnit ,String doc_precioUnit, String doc_total) {
        this.doc_id = doc_id;
        this.doc_item = doc_item;
        this.doc_cantidad = doc_cantidad;
        this.doc_desc = doc_desc;
        this.doc_valorUnit=doc_valorUnit;
        this.doc_precioUnit = doc_precioUnit;
        this.doc_total = doc_total;
    }
    ...
    public String getDoc_valorUnit() {
        return doc_valorUnit;
    }

    public void setDoc_valorUnit(String doc_valorUnit) {
        this.doc_valorUnit = doc_valorUnit;
    }
