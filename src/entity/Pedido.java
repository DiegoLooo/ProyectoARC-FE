...
public class Pedido {
   ...
   String montoFact;
    ...
    public Pedido(int idPedido, int numPedido, int idProforma, int idCliente, int idContactoCliente, int idUsuario, String moneda, String formPago, String tipo, String fechaEmision, int dia1, int dia2,String detalleOrden, String numOrden,String estado, String Observacion, String observacionInterna,  String campo3) {
    ...
    public Pedido(int numPedido, int idProforma, int idCliente, int idContactoCliente, int idUsuario, String moneda, String formPago, String tipo, String fechaEmision, int dia1, int dia2, String detalleOrden, String numOrden,String estado, String Observacion, String observacionInterna,  String campo3) {
        this.numPedido = numPedido;
        this.idProforma = idProforma;
        this.idCliente = idCliente;
        this.idContactoCliente = idContactoCliente;
    ...
    public Pedido(int idPedido, int numPedido, int idProforma, int idCliente, int idContactoCliente, int idUsuario, String moneda, String formPago, String tipo, String fechaEmision, int dia1, int dia2, String detalleOrden, String numOrden,String estado, String Observacion, String observacionInterna) {
        this.idPedido = idPedido;
        this.numPedido = numPedido;
        this.idProforma = idProforma;
        this.idCliente = idCliente;
