...
public class OrdenCompra {
    ...
    public OrdenCompra(int oc_id, int oc_num, String oc_fecha, int oc_idProveedor_fk, int oc_idContactoProv_fk, String oc_moneda, String oc_formaPago, String oc_tiempoEntrega, String oc_fechaEntrega, String oc_docExterno, int oc_idUsuario_fk, String oc_lugarEntrega, String oc_estado, String oc_observacion, String oc_obsInterna) {
        ...
        this.oc_obsInterna = oc_obsInterna; 
    }

    public OrdenCompra(int oc_id, int oc_num, String proveedor, String contacto, String oc_fecha, String oc_formaPago, String oc_tiempoEntrega, String oc_fechaEntrega, String oc_lugarEntrega, String oc_estado, String oc_observacion, String oc_obsInterna ) {
        this.oc_id = oc_id;
        this.oc_num = oc_num;
    ...
    public String getOc_obsInterna() {
        return oc_obsInterna;
    }

    public void setOc_obsInterna(String oc_obsInterna) {
        this.oc_obsInterna = oc_obsInterna;
    }
