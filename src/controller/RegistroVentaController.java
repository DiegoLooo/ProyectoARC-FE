...
public class RegistroVentaController {
    ...
    public List<RegistroVenta> RegistroVentaCuentasCobrarClientes(String nombre, String valor) throws Exception {
        return dao.findCuentasPorCobrarClientes(nombre, valor);
    }
